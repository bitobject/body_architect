defmodule BodyArchitect.UsersTest do
  ...
  describe "users" do
    ...
    @invalid_attrs %{age: nil, current_weight: nil, image: nil, name: nil, type: nil}
    ...
    test "create_user/1 with valid data creates a user" do
      ...
      assert user.age == 42
      assert user.current_weight == 120.5
    ...
    test "update_user/2 with valid data updates the user" do
      ...
      assert user.age == 43
      assert user.current_weight == 456.7
  ...
  import BodyArchitect.UsersFixtures
  alias BodyArchitect.Users.{User, UserToken}
